...
var componentsJsPath = 'craft/web/assets/js/components/*.js'; // component js files
var scriptsJsPath = 'craft/web/assets/js'; //folder for final scripts.js/scripts.min.js files

// css file paths
var cssFolder = 'craft/web/assets/css'; // folder for final style.css/style-custom-prop-fallbac.css files
var scssFilesPath = 'craft/web/assets/css/**/*.scss'; // scss files to watch
...
gulp.task('watch-ie', gulp.series(['browserSync', 'sass-ie', 'scripts'], function () {
  gulp.watch('craft/templates/**/*.twig', gulp.series(reload));
  gulp.watch('craft/web/assets/css/**/*.scss', gulp.series(['sass-ie']));
  gulp.watch(componentsJsPath, gulp.series(['scripts']));
}));
...
function purgeCSS() {
  return new Promise(function(resolve, reject) {
    ...
    .pipe(purgecss({
      content: ['craft/templates/**/*.twig', scriptsJsPath+'/scripts.js'],
